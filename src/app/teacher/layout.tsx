...
import { ClipboardCheck, Clock, Menu, X, GraduationCap, PlusCircle, Users, Award, Home } from "lucide-react";
      ...
      <aside className={cn(
        ...
        <div className="flex h-full flex-col">
          <div className="flex items-center justify-between border-b px-4 py-4">
            <Link href="/teacher/evaluation" className="flex items-center gap-2">
              <GraduationCap className="size-6 text-blue-600" />
              <span className="font-bold text-foreground">SkillChain อาจารย์</span>
            </Link>
